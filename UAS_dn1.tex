...
\item[(b)] Preverimo najprej, da je $R$ zaprta za invertiranje. Naj bo $a\in R$ in $p\in \Z[x]$ polinom oblike $p(x) = \alpha_0 x^n + \alpha_1 x^{n-1} + \dots  + \alpha_{n-1}x +\alpha_n$, ki zadošča $0=p(a) =  \alpha_0 a^n + \alpha_1 a^{n-1} + \dots  + \alpha_{n-1}a +\alpha_n = a^n (\alpha_0 + \alpha_1 a^{-1} + \dots + \alpha_{n-1} (a^{-1})^{n-1} + \alpha_n (a^{-1})^{n})$. Sledi, da je $(\alpha_0 + \alpha_1 a^{-1} + \dots + \alpha_{n-1} (a^{-1})^{n-1} + \alpha_n (a^{-1})^{n}) = 0$ in zato za polinom $\tilde{p}(x) = (\alpha_0 + \alpha_1 x + \dots + \alpha_{n-1} x^{n-1} + \alpha_n x^{n})$ velja $\tilde{p}(a^{-1}) = 0$. Sledi, da je $a^{-1}\in R$.
